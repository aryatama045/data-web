                    ...
                    <div class="nav-panel nav-panel--sticky" data-sticky-mode="alwaysOnTop">
                        <div class="nav-panel__container container" style="padding-left: 160px;">
                            <div class="nav-panel__row">
                                ...
                                <a style="    position: fixed;left: 1em;" href="https://binamarga.pu.go.id/" target="_blank" class="site-header__logo2">
                                ...
                                <?php
                                    $logo = $this->M_app->view_ordering_limit('tb_web_logo', 'id_logo', 'DESC', 0, 1);
                                    foreach ($logo->result_array() as $row) {
                                        echo "<a href='https://pu.go.id/' target='_blank' class='site-header__logo'><img  src='" . base_url() . "assets/images/logo/$row[gambar]'/></a>";
                                    }
                                ?>
